        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Fly high</h1>
              <p>The No. 1 Travel site in America</p>
              <p><a class="btn btn-lg btn-primary" href="register_form.html" role="button">Sign up today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Fly high</h1>
              <p>Plan your journey here. Leave Everything to us.</p>
...
function submit_sign() {
  var error = "";
  error = error + validatePassword(document.getElementById("paswd"));
  error = error + validateEmail(document.getElementById("uname"));
  if(document.getElementById("uname").value == "" || document.getElementById("paswd").value == "")
  {
     error = error + "The required field has not been filled in.\n";
