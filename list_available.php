    ...
    <li><a href="ticket_list.php">Orders</a></li>
            ...
            <?php 
                  ...
                  {    echo "";
                    ...
                    <li role="separator" class="divider"></li>
                    <!--<li><a href="flightAdd.php">Admin</a></li> -->
...
echo '</br></br></br>';
        ...
        echo "<th onclick='sort_table(list_avail, 1, asc2); asc2 *= -1; asc1 = 1; asc3 = 1;asc4 = 1;asc5 = 1;asc6 = 1;asc7 = 1;'> Flight </th>";
        echo "<th onclick='sort_table(list_avail, 2, asc3); asc3 *= -1; asc2 = 1; asc1 = 1;asc4 = 1;asc5 = 1;asc6 = 1;asc7 = 1;'> Airways </th>";
        echo "<th onclick='sort_table(list_avail, 3, asc4); asc4 *=  -1; asc2 = 1; asc3 = 1;asc1 = 1;asc5 = 1;asc6 = 1;asc7 = 1;'> Origin </th>";
        echo "<th onclick='sort_table(list_avail, 4, asc5); asc5 *=  -1; asc2 = 1; asc3 = 1;asc4 = 1;asc1 = 1;asc6 = 1;asc7 = 1;'> Destination </th>";
        echo "<th onclick='sort_table(list_avail, 5, asc6); asc6 *=  -1; asc2 = 1; asc3 = 1;asc4 = 1;asc5 = 1;asc1 = 1;asc7 = 1;'> Availability </th>";
        echo "<th onclick='sort_table(list_avail, 6, asc7); asc7 *=  -1; asc2 = 1; asc3 = 1;asc4 = 1;asc5 = 1;asc6 = 1;asc1 = 1;'> Price </th>";
...
////////////////////////////////////
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
        ...
        setTimeout("window.location.assign('http://localhost:600/airline/ticket_list.php')",2500);
    }
