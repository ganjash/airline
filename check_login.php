...
session_destroy();
    ...
    if ($result->num_rows > 0) {
        ...
        $str1 = "<form class=\"navbar-form navbar-right form-signin\" action=\"list_available.php\" method=\"POST\">
                <div class=\"dropdown\">
  ...
  <li><a href=\"ticket_list.php\">Orders</a></li>";
                  ...
                  if( (strcmp($_COOKIE["user_id"], $admin_email) == 0 ) || (strcmp($user_name, $admin_email) == 0) ) 
                  {   
                    $str1 = $str1 . "<li role=\"separator\" class=\"divider\"></li><li><a href=\"adminOperations.php\">Admin</a></li> ";
             
                 }
        $str1 = $str1 . "<li role=\"separator\" class=\"divider\"></li>
