...
?>
 ...
 <div class="container">
          <div class="row row-centered">
              ...
              <input class="btn btn-primary" value="Modify Flight" onclick="flightUpdate()">
...
function flightUpdate(){
     ...
     var i = 0;
        ...
        var zz = $(xx[i]).parent().siblings();
        window.location.assign("flightUpdate.php"+"?flight_no="+$(zz[0]).text()+"&airways_id="+$(zz[1]).text()+"&capacity="+$(zz[3]).text()+"&origin="+$(zz[4]).text()+"&desti="+$(zz[5]).text());
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
        ...
        setTimeout("location.reload()",3000);
              ...
              document.getElementById("status_msg").innerHTML = "<div class=\"alert alert-danger fade in\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a><strong>Failed!</strong> You Can't Delete Flight    id: "+ yy +" Tickets booked on it!!!  </div>";
        //setTimeout("location.reload()",3000);
    }
